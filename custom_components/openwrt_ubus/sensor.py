...
from .sensors import system_sensor, qmodem_sensor, statistic_sensor, accesspoint_sensor
...
SENSOR_MODULES = [
    ...
    {
        "module": sta_sensor,
        "config_key": CONF_ENABLE_STATION_SENSORS,
        "default": DEFAULT_ENABLE_STA_SENSORS,
        "name": "sta_sensor"
    },
    {
        "module": ap_sensor,
        "config_key": CONF_ENABLE_ACCESS_POINT_SENSORS,
